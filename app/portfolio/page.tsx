...
export default async function WorksPage() {
  ...
  return (
    <div className="min-h-[100dvh] bg-gradient-to-tl from-black via-indigo-900/50 to-black">
      <Navigation />
      <div className="px-6 pt-20 mx-auto space-y-8 max-w-7xl lg:px-8 md:space-y-16 md:pt-24 lg:pt-32">
        <div className="max-w-2xl mx-auto lg:mx-0">
          <h2 className="font-display text-2xl font-bold tracking-tight text-zinc-100 sm:text-4xl">
            Portfolio / ポートフォリオ
          </h2>
